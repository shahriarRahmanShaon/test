...
@section('content')
    <form action="{{ route('books.update', ['book' => $book]) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" value="{{ $book->title ? $book->title : old('title') }}">
            @error('title')
        ...
        <div class="form-group">
            ...
            <input type="text" name="author" class="form-control"
                value="{{ $book->author ? $book->author : old('author') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="isbn" class="form-control" value="{{ $book->isbn ? $book->isbn : old('isbn') }}">
